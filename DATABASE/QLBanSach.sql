...
insert into Sach(id, tenSach, theLoai, tacGia, nhaXuatBan, soLuong, giaBan, maKho, hinhAnh, trangThai) values 
...
insert into Viet(maTG, maSach) values ();
...
insert into NhaXuatBan(maNXB, tenNXB, diaChiNXB, sdt) values 
	('XB01', N'Thế giới', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB02', N'Đại Học Quốc Gia Hà Nội', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB03', N'Nhà Xuất Bản Hồng Đức', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB04', N'Tổng Hợp TPHCM', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB05', N'Nhà Xuất Bản Phụ Nữ', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB06', N'Nhà Xuất Bản Lao Động Xã Hội', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB07', N'Nhà Xuất Bản Chính Trị Quốc Gia Sự Thật', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB08', N'Nhà Xuất Bản Xây Dựng', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB09', N'Nhà Xuất Bản Giáo Dục Việt Nam', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB10', N'NXB Trẻ', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB11', N'Penguin', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB12', N'Nhà Xuất Bản Kim Đồng', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223'),
	('XB13', N'Nhà Xuất Bản Đà Nẵng', N'275 An Dương Vương P16, Q8, TP. HCM', '0862761223');
...
insert into HoaDon(soHD, maNV, ngayBan, trangThai) values
	('HD01', 'NV01', '2023-09-16', 0),
	('HD02', 'NV01', '2023-10-06', 2),
	('HD03', 'NV03', '2023-08-06', 2),
	('HD04', 'NV02', '2023-08-30', 2),
	('HD05', 'NV03', '2023-10-10', 2),
	('HD06', 'NV01', '2023-10-10', 0),
	('HD07', 'NV03', '2023-10-08', 2),
	('HD08', 'NV03', '2023-09-13', 2);
------------------ Chi tiết hóa đơn ------------------------------------------------------------------------------------
...
insert into ChiTietHoaDon(soHD,maSach, soLuongBan, giaBan) values
	('HD01', null, 5, 300000),
	('HD01', null, 3, 285000),
	('HD01', null, 8, 1360000),
	('HD02', null, 3, 210000),
...
insert into PhieuNhap(soPN, maNV, maNXB, maKho,ngayNhap, tongTien, trangThai) values 
...
insert into ChiTietPhieuNhap(soPN, maSach, soLuongNhap, giaNhap, trangThai) values
('PN01','S001',2,35000, 1),
...
insert into KhoSach(maKho, tenKho, diaChi, loai) values
	('K001', N'Khu vực A',N'99 Anh Dương Vương P16, Q8, TP. Hồ Chí Minh', N'Loại A'),
	('K002', N'Khu vực B', N'273 An Dương Vương P2, Q5, TP. Hồ Chí Minh', N'Loại A'),
	('K003', N'Khu vực C', N'105 Bà Huyện Thanh Quan, Phường 6, Quận 3, TP. Hồ Chí Minh', N'Loại AB'),
	('K004', N'Khu vực D', N'4 Tôn Đức Thắng, Bến Nghé, Quận 1, TP. Hồ Chí Minh', N'Loại A');
...
insert into NhanVien(maNV, tenNV, gioiTinh, diaChi, ngayVao, sdt, ngaySinh) values 
	('NV01', N'Nguyễn Hoàng Mai Vy', 0, N'99 Anh Dương Vương P16, Q8, TP. Hồ Chí Minh', '2022-01-12', '0862498257', '2004-05-24'),
	('NV02', N'Lê Hoàng A', 0, N'273 An Dương Vương P2, Q5, TP. Hồ Chí Minh', '2022-01-14', '0123456789', '2004-05-24'),
	('NV03', N'Trần Nhật Sinh', 1, N'273 An Dương Vương P2, Q5, TP. Hồ Chí Minh', '2022-02-15', 'HD01', '2003-12-20');
...
insert into KhachHang(maKH, tenKH, diaChi, maHD, sdt, trangThai) values 
...
insert into TaiKhoan(useName, sdt, matKhau, maNV, maNhomQuyen, trangThai) values 
...
(1, N'Admin', 1),
(2, N'Quản lý bán hàng', 1),
(3, N'Quản lý kho', 1),
(4, N'Khách hàng', 1);

SELECT * FROM nhomQuyen WHERE maNhomQuyen LIKE '%khách%' OR tenNhomQuyen LIKE '%khách%'
