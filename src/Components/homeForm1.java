...
public class homeForm1 extends JPanel{
	...
	public void init() {
		...
		mc2.setBounds(360,42,13,13);
		this.add(mc2);
		JLabel lb15 = new JLabel("Số lượng sách");
		lb15.setFont(new Font("Arial",Font.PLAIN,12));
		lb15.setBounds(280,39,120,20);
		this.add(lb15);
		
		JPanel mc3 = new JPanel();
		mc3.setBackground(color2);
		mc3.setBounds(506,42,13,13);
		this.add(mc3);
		JLabel lb16 = new JLabel("Trung bình sách tồn");
		lb16.setFont(new Font("Arial",Font.PLAIN,12));
		lb16.setBounds(400,39,150,20);
		this.add(lb16);
